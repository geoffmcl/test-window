...
@REM set TMPOPTS=%TMPOPTS% -DBUILD_SHARED_LIBS:BOOL=OFF -DBUILD_STATIC_LIBS:BOOL=ON 
@REM set TMPOPTS=%TMPOPTS% -DBUILD_TESTING:BOOL=ON
...
@if NOT "%ADDRELDBG%" == "1" goto DNRELDBG
